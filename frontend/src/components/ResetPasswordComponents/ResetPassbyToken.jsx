    ...
    <div className='contentReset'>
      ...
      {CpfPass && <div className='ResetBox'>
        ...
        <form className='formReset' onSubmit={handleSubmit}>
          ...
          <label htmlFor='ResetPassword' className='inputLabel' id='labelNewResetPassword'>
          ...
          <label htmlFor='ResetConfirmPass' className='inputLabel' id='labelNewResetEmail'>
     ...
     {!CpfPass && <div className='ResetBox' id="CPF CHECK - compomente de checar cpf email"> 
        ...
        <label htmlFor='ResetCPF' className='inputLabel' id='labelNewResetPassword'>
            <span className='inputDescription'>Informe o CPF da conta cadastrada:</span> 
              <input 
                type='text' 
