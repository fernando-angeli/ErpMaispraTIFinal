            ...
            <div className="divRadios divCheckboxes">
              <label htmlFor="ativos" className='labelCheckbox'>
                <input
                  ...
                  id="ativos" className='inputRadio inputCheckbox'
                  onClick={() => setAtivos(!ativos)}
                  defaultChecked />
                <label className='text labelRadio' htmlFor='ativos'>Ativos</label>
              </label>
              ...
              <label htmlFor="inativos" className='labelCheckbox'>
                <input
                  ...
                  defaultChecked />
                <label className='text labelRadio' htmlFor='inativos'>Inativos</label>
              </label>
            </div>
