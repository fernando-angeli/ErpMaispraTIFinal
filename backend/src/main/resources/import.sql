...
INSERT INTO tb_products (supplier_code, name, description, unit_of_measure, price, stock, reserved_stock, incoming_stock) VALUES ('SUPP001', 'Produto A', 'Descrição do Produto A', 'UNIT', 50.00, 100, 10, 5);
INSERT INTO tb_products (supplier_code, name, description, unit_of_measure, price, stock, reserved_stock, incoming_stock) VALUES ('SUPP002', 'Produto B', 'Descrição do Produto B', 'UNIT', 30.00, 200, 20, 10);
INSERT INTO tb_products (supplier_code, name, description, unit_of_measure, price, stock, reserved_stock, incoming_stock) VALUES ('SUPP003', 'Produto C', 'Descrição do Produto C', 'BAR', 25.00, 150, 15, 0);
INSERT INTO tb_products (supplier_code, name, description, unit_of_measure, price, stock, reserved_stock, incoming_stock) VALUES ('SUPP004', 'Produto D', 'Descrição do Produto D', 'KG', 75.00, 80, 5, 2);
INSERT INTO tb_products (supplier_code, name, description, unit_of_measure, price, stock, reserved_stock, incoming_stock) VALUES ('SUPP005', 'Produto E', 'Descrição do Produto E', 'UNIT', 100.00, 50, 5, 1);
...
INSERT INTO tb_sale_items (product_id, quantity_sold, quantity_delivered, sale_id) VALUES (1, 2, 1, 1);  -- Produto com ID 1, 2 vendidos, 1 entregue, na venda com ID 1
INSERT INTO tb_sale_items (product_id, quantity_sold, quantity_delivered, sale_id) VALUES (2, 3, 2, 1);  -- Produto com ID 2, 3 vendidos, 2 entregues, na venda com ID 1
INSERT INTO tb_sale_items (product_id, quantity_sold, quantity_delivered, sale_id) VALUES (3, 1, 1, 1);  -- Produto com ID 3, 1 vendido, 1 entregue, na venda com ID 1
INSERT INTO tb_sale_items (product_id, quantity_sold, quantity_delivered, sale_id) VALUES (1, 5, 0, 1);  -- Produto com ID 1, 5 vendidos, 0 entregues, na venda com ID 2
INSERT INTO tb_sale_items (product_id, quantity_sold, quantity_delivered, sale_id) VALUES (4, 2, 1, 1);  -- Produto com ID 4, 2 vendidos, 1 entregue, na venda com ID 2
